        ...
        <div className='grid grid-cols-1  lg:grid-cols-2 lg:gap-28'>
            <div className='flex flex-col items-center'>
                <div>
                    <blockquote className='mb-8'>
                        <h3 className='mb-4 text-[16px] md:text-[20px] fony-semibold '> Solid foundation for any project</h3>
            ...
            <div className='grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-4'>
                <div className='flex items-center'>
                    ...
                    <p className='font-bold text-4xl '>8,296</p>
                    <div className='flex items-center mt-3'>
                    <FaGithub  className={`h-6 w-6 mr-2 ${darkMode ? "dark:text-gray-500" : "text-gray-300 "}`}/>
                    <p className={` text-[16px] ${darkMode ? "dark:text-gray-400" : "text-gray-500"}`}>Stars on Github</p>
                    </div>
                ...
                <div className='flex items-center'>
                    <div className={`p-5 rounded-lg hover:shadow-md ${darkMode ? "dark:hover:bg-gray-700" : "hover:bg-gray-100 "} `}>
                    <p className='font-bold text-4xl '>19,393,236</p>
                    <div className='flex items-center mt-3'>
                    <FaGithub  className={`h-6 w-6 mr-2 ${darkMode ? "dark:text-gray-500" : "text-gray-300 "}`}/>
                    <p className={` text-[16px] ${darkMode ? "dark:text-gray-400" : "text-gray-500"}`}>Downloads on NPM</p>
                    </div>
