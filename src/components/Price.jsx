            ...
            <div className='overflow-hidden min-w-max'>
                ...
                <div className={`grid grid-cols-4 p-4 text-sm font-medium  border-b gap-x-16 ${darkMode ? " border-gray-700 text-white " : "border-gray-200 text-gray-70 "}`}>
                 ...
                 <div className={`grid grid-cols-4 p-4 text-sm font-medium border-t border-b gap-x-16 ${darkMode ? "bg-gray-800 border-gray-700 text-white " : "border-gray-200 text-gray-900 bg-gray-100 "}`}>
                    <div className='flex items-center'>
                        <div className='relative w-6 h-6'>
                            <img src={Tailwind} alt='' loading='eager'/>
                        </div>
                        <span className='ml-3'>Tailwind CSS v4 (HTML)</span>
                    </div>
                    <div className=''>Community Edition</div>
                    <div className=''>Developer Edition</div>
                    <div className=''>Designer Edition</div>
                ...
                <div className={`grid grid-cols-4 p-4 text-sm font-medium  border-b gap-x-16 ${darkMode ? " border-gray-700 text-white " : "border-gray-200 text-gray-70 "}`}>
                    <div className={`${darkMode ? " text-gray-400" : "text-gray-500 "}`}>Core UI components (<span className='text-blue-600'>view docs</span>)</div>
                    <div className='text-green-500'><IoMdCheckmark className='w-5 h-5' /></div>
                    <div className='text-green-500'><IoMdCheckmark className='w-5 h-5' /></div>
                    <div className='text-green-500'><IoMdCheckmark className='w-5 h-5' /></div>
                ...
                <div className={`grid grid-cols-4 p-4 text-sm font-medium border-t border-b gap-x-16 ${darkMode ? "bg-gray-800 border-gray-700 text-white " : "border-gray-200 text-gray-900 bg-gray-100 "}`}>
                    <div className='flex items-center'>
                        <div className='relative w-4 h-4'>
                            <img src={Figma} alt='' loading='eager'/>
                        </div>
                        <span className='ml-3'>Figma design files</span>
                    </div>
                    <div className=''>Community Edition</div>
                    <div className=''>Developer Edition</div>
                    <div className=''>Designer Edition</div>
                ...
                <div className={`grid grid-cols-4 p-4 text-sm font-medium  border-b gap-x-16 ${darkMode ? " border-gray-700 text-white " : "border-gray-200 text-gray-70 "}`}>
                    <div className={`${darkMode ? " text-gray-400" : "text-gray-500 "}`}>Free edition (<span className='text-blue-600'>duplicate from Figma</span>)</div>
                    <div className='text-green-500'><IoMdCheckmark className='w-5 h-5' /></div>
                    <div className='text-green-500'><IoMdCheckmark className='w-5 h-5' /></div>
                    <div className='text-green-500'><IoMdCheckmark className='w-5 h-5' /></div>
                ...
                <div className={`grid grid-cols-4 p-4 text-sm font-medium  border-b gap-x-16 ${darkMode ? " border-gray-700 text-white " : "border-gray-200 text-gray-70 "}`}>
                    <div className={`${darkMode ? " text-gray-400" : "text-gray-500 "}`}>Flowbite Icons (<span className='text-blue-600'>duplicate from Figma </span>)</div>
                    <div className='text-green-500'><IoMdCheckmark className='w-5 h-5' /></div>
                    <div className='text-green-500'><IoMdCheckmark className='w-5 h-5' /></div>
                    <div className='text-green-500'><IoMdCheckmark className='w-5 h-5' /></div>
                ...
                <div className={`grid grid-cols-4 p-4 text-sm font-medium border-t border-b gap-x-16 ${darkMode ? "bg-gray-800 border-gray-700 text-white " : "border-gray-200 text-gray-900 bg-gray-100 "}`}>
                    <div className='flex items-center'>
                        <div className='relative w-6 h-6'>
                            <img src={Reacts} alt='' loading='eager'/>
                        </div>
                        <span className='ml-3'>React components (TypeScript)</span>
                    </div>
                    <div className=''>Community Edition</div>
                    <div className=''>Developer Edition</div>
                    <div className=''>Designer Edition</div>
                ...
                <div className={`grid grid-cols-4 p-4 text-sm font-medium  border-b gap-x-16 ${darkMode ? " border-gray-700 text-white " : "border-gray-200 text-gray-70 "}`}>
                    <div className={`${darkMode ? " text-gray-400" : "text-gray-500 "}`}>Free edition (<span className='text-blue-600'>view demo</span>)</div>
                    <div className='text-green-500'><IoMdCheckmark className='w-5 h-5' /></div>
                    <div className='text-green-500'><IoMdCheckmark className='w-5 h-5' /></div>
                    <div className='text-green-500'><IoMdCheckmark className='w-5 h-5' /></div>
                ...
                <div className={`grid grid-cols-4 p-4 text-sm font-medium  border-b gap-x-16 ${darkMode ? " border-gray-700 text-white " : "border-gray-200 text-gray-70 "}`}>
                    <div className={`${darkMode ? " text-gray-400" : "text-gray-500 "}`}>Flowbite Icons </div>
                    <div className='text-green-500'><IoMdCheckmark className='w-5 h-5' /></div>
                    <div className='text-green-500'><IoMdCheckmark className='w-5 h-5' /></div>
                    <div className='text-green-500'><IoMdCheckmark className='w-5 h-5' /></div>
                ...
                <div className={`grid grid-cols-4 p-4 text-sm font-medium  border-b gap-x-16 ${darkMode ? " border-gray-700 text-white " : "border-gray-200 text-gray-70 "}`}>
                    <div className={`${darkMode ? " text-gray-400" : "text-gray-500 "} flex`}>E-commerce UI Block
                    </div>
                    <div className='text-red-500'><IoClose className='w-5 h-5' /></div>
                    <div className='text-green-500'><IoMdCheckmark className='w-5 h-5' /></div>
                    <div className='text-red-500'><IoClose className='w-5 h-5' /></div>
