    ...
    <div className="pb-8 lg:pb-26">
      <div className="px-6 max-w-[1440px] mx-auto lg:text-center">
        <div className="w-full mb-6">
          ...
          >
            <div className="flex flex-col items-center sm:flex-row shrink-0 w-full sm:w-auto">
          ...
          ${
            darkMode
              ...
              <div
                className={`w-full flex justify-between items-center text-sm gap-4 px-4 py-2 pl-2 border outline-none rounded-md focus:ring-blue-500 focus:border-blue-500 
          ${
            darkMode
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-10">
            <div
              className={`h-64 md:h-80 cursor-pointer rounded-lg border ${
                darkMode
                  ? "dark:border-gray-800 dark:hover:border-gray-700 dark:shadow-lg-light dark:bg-gray-900 "
                  : "border-gray-100 hover:border-white"
              }`}
            >
              <div
                className={` rounded-t-md py-2.5 px-5 flex  justify-between items-center border-b ${
                  darkMode
              ...
              >
                ...
                <div
                  className={`rounded ${
                    darkMode
                      ? "dark:bg-green-200 dark:text-green-400"
                      : "bg-green-100 text-green-800"
                  }inline-flex `}
                >
                  <span className="text-[11px] font-medium px-2.5 py-0.5 text-center">
                    Marketing UI
                  </span>
                </div>
              </div>
              ...
              <div className="relative flex items-center justify-center h-[calc(100%-4rem)]">
                ...
                >
                  <img
                    src={DarkHero}
                    alt="image"
                    className="h-44 md:h-52 mx-auto max-w-full"
                  />
                </div>
            ...
            >
              ...
              >
                ...
                <div
                  className={`rounded ${
                    darkMode
                      ? "dark:bg-blue-200 dark:text-blue-400"
